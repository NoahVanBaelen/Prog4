...
void dae::Renderer::RenderTexture(const Texture2D& texture, float x, float y, float width, float height, SDL_Rect& srcRect) const
{
	SDL_Rect dst{};
	dst.x = static_cast<int>(x);
	dst.y = static_cast<int>(y);
...
void dae::Renderer::RenderTexture(const Texture2D& texture, SDL_Rect& dstRect, SDL_Rect& srcRect) const
{
